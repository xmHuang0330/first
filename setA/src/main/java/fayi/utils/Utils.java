...
public class Utils {
    ...
    public static Platform getCurrentPlatform() throws SetAException {
        ...
        } else if (uname.contains("windows")) {
            platform = Platform.windows;
        } else if (uname.contains("mac os x")) {
            platform = Platform.mac;
        }else{
            throw new SetAException(301, "Platform not supported...");
        }
        return platform;
    }
